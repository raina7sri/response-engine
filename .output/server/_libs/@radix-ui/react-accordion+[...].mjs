	...
	const handleKeyDown = composeEventHandlers(props.onKeyDown, (event) => {
		...
		switch (event.key) {
			...
			case "ArrowLeft":
				...
				break;
			case "ArrowUp":
				if (orientation === Orientation.Vertical) movePrev();
				break;
		}
...
//#endregion
export { useComposedRefs as _, AccordionTrigger as a, useId as c, createCollection as d, createContextScope as f, createSlot as g, Slot as h, AccordionItem as i, useLayoutEffect2 as l, dispatchDiscreteCustomEvent as m, AccordionContent as n, useControllableState as o, Primitive as p, AccordionHeader as r, Presence as s, Accordion as t, useDirection as u, require_jsx_runtime as v };
